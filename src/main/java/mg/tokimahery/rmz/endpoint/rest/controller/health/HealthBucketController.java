...
import static mg.tokimahery.rmz.file.hash.FileHashAlgorithm.NONE;
...
import mg.tokimahery.rmz.file.bucket.BucketComponent;
import mg.tokimahery.rmz.file.hash.FileHash;
