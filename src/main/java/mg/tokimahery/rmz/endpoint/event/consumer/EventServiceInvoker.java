package mg.tokimahery.rmz.endpoint.event.consumer;
...
import mg.tokimahery.rmz.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("mg.tokimahery.rmz.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "mg.tokimahery.rmz.service.event."
